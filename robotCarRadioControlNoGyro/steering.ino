...
void calculateSpeed(int mSpeed, int angle, double error){
  calculatedSpeed[0] = (mSpeed*sin(radians(angle)+M_PI/4)*sqrt(2)) - error; // enAL
  calculatedSpeed[1] = (mSpeed*cos(radians(angle)+M_PI/4)*sqrt(2))+error; // enAR
  calculatedSpeed[2] = (mSpeed*cos(radians(angle)+M_PI/4)*sqrt(2))- error; // enBL
  calculatedSpeed[3] = (mSpeed*sin(radians(angle)+M_PI/4)*sqrt(2))+error; // enBR
}
...
//    Serial.print(" | radioAngel  = "); Serial.print(angle);
//    Serial.print(" | radioSpeed  = "); Serial.print(mSpeed);
//    Serial.println("");  
